...
public class FontsContractCompat {
    ...
    public static Typeface getFontSync(final Context context, final FontRequest fontRequest, final ResourcesCompat.FontCallback fontCallback, final Handler handler, boolean z, int i, final int i2) {
        final String str = fontRequest.getIdentifier() + Operators.SUB + i2;
        ...
        try {
            ...
            if (cursorQuery != null && cursorQuery.getCount() > 0) {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(uriWithAppendedId, i2, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : StatFsHelper.DEFAULT_DISK_YELLOW_LEVEL_IN_MB, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i));
                }
