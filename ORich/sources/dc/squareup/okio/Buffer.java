...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public static final class UnsafeCursor implements Closeable {
        ...
        public final int seek(long j) {
            ...
            throw new ArrayIndexOutOfBoundsException(StringUtil.format("offset=%s > size=%s", Long.valueOf(j), Long.valueOf(this.buffer.size)));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x003d, code lost:
        ...
        r1 = new dc.squareup.okio.Buffer().writeDecimalLong(r3).writeByte((int) r15);
     */
    ...
    */
    int selectPrefix(dc.squareup.okio.Options r18, boolean r19) {
        /*
            ...
            r0 = r18
            r1 = r17
            dc.squareup.okio.Segment r2 = r1.head
            r3 = -2
            if (r2 != 0) goto L13
            if (r19 == 0) goto Lc
            return r3
        Lc:
            dc.squareup.okio.ByteString r2 = dc.squareup.okio.ByteString.EMPTY
        ...
        L47:
            if (r9 != r6) goto L62
            dc.squareup.okio.Segment r4 = r11.next
            int r6 = r4.pos
            byte[] r9 = r4.data
            int r11 = r4.limit
            if (r4 != r2) goto L5c
        ...
        L80:
            ...
            r5 = r0[r13]
            if (r14 != r6) goto L95
            dc.squareup.okio.Segment r11 = r11.next
            int r3 = r11.pos
            byte[] r4 = r11.data
            int r6 = r11.limit
            if (r11 != r2) goto L96
    ...
    public long indexOf(byte b, long j, long j2) {
        ...
        throw new IllegalArgumentException(StringUtil.format("size=%s fromIndex=%s toIndex=%s", Long.valueOf(this.size), Long.valueOf(j), Long.valueOf(j2)));
    }
        ...
        if (i2 >= i) {
            ...
            while (i < i2) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    if (cCharAt2 < 2048) {
                        writeByte((cCharAt2 >> 6) | JfifUtil.MARKER_SOFn);
    ...
    public final Buffer copyTo(Buffer buffer, long j, long j2) {
        if (buffer != null) {
            ...
            while (j2 > 0) {
                ...
                int i = (int) (((long) segmentSharedCopy.pos) + j);
