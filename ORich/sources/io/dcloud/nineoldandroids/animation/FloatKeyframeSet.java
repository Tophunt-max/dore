...
class FloatKeyframeSet extends KeyframeSet {
    ...
    public float getFloatValue(float f) {
        ...
        if (i == 2) {
            ...
            return typeEvaluator == null ? this.firstValue + (f * this.deltaValue) : ((Number) typeEvaluator.evaluate(f, Float.valueOf(this.firstValue), Float.valueOf(this.lastValue))).floatValue();
        }
        if (f <= 0.0f) {
            ...
            return typeEvaluator2 == null ? floatValue2 + (f2 * (floatValue3 - floatValue2)) : ((Number) typeEvaluator2.evaluate(f2, Float.valueOf(floatValue2), Float.valueOf(floatValue3))).floatValue();
        }
        if (f >= 1.0f) {
            ...
            return typeEvaluator3 == null ? floatValue4 + (f3 * (floatValue5 - floatValue4)) : ((Number) typeEvaluator3.evaluate(f3, Float.valueOf(floatValue4), Float.valueOf(floatValue5))).floatValue();
        }
        ...
        while (true) {
            ...
            if (f < floatKeyframe6.getFraction()) {
                ...
                return typeEvaluator4 == null ? floatValue6 + (fraction5 * (floatValue7 - floatValue6)) : ((Number) typeEvaluator4.evaluate(fraction5, Float.valueOf(floatValue6), Float.valueOf(floatValue7))).floatValue();
            }
            i2++;
    ...
    public FloatKeyframeSet m20clone() {
        ArrayList<Keyframe> arrayList = this.mKeyframes;
        int size = arrayList.size();
        Keyframe.FloatKeyframe[] floatKeyframeArr = new Keyframe.FloatKeyframe[size];
        for (int i = 0; i < size; i++) {
            floatKeyframeArr[i] = (Keyframe.FloatKeyframe) arrayList.get(i).m19clone();
        }
