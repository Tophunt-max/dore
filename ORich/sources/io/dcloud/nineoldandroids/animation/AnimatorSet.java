...
public final class AnimatorSet extends Animator {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m18clone() {
            try {
                ...
                node.animation = this.animation.m17clone();
                return node;
    ...
    private void sortNodes() {
        ...
        for (int i3 = 0; i3 < size3; i3++) {
            ...
            ArrayList<Dependency> arrayList3 = node2.dependencies;
        ...
        while (arrayList2.size() > 0) {
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                ...
                ArrayList<Node> arrayList5 = node3.nodeDependents;
                if (arrayList5 != null) {
    ...
    public AnimatorSet m17clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.m17clone();
        ...
        for (Node node : this.mNodes) {
            Node nodeM18clone = node.m18clone();
            map.put(node, nodeM18clone);
            animatorSet.mNodes.add(nodeM18clone);
            animatorSet.mNodeMap.put(nodeM18clone.animation, nodeM18clone);
            ArrayList arrayList = null;
            nodeM18clone.dependencies = null;
            nodeM18clone.tmpDependencies = null;
            nodeM18clone.nodeDependents = null;
            nodeM18clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM18clone.animation.getListeners();
            if (listeners != null) {
