    ...
    public boolean updateViewData(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            if (!jSONObject.isNull("background")) {
                try {
                    lowerCase = JSONUtil.getString(jSONObject, "background").toLowerCase();
                } catch (Exception e) {
                    e = e;
                }
                try {
            ...
            if (!jSONObject.isNull(AbsoluteConst.JSON_KEY_TABBG)) {
                lowerCase2 = JSONUtil.getString(jSONObject, AbsoluteConst.JSON_KEY_TABBG).toLowerCase();
            ...
            if (!jSONObject.isNull(AbsoluteConst.JSON_KEY_ANIMATION_ALPHA_BG)) {
                ...
                try {
                    this.animationAlphaBackground = lowerCase2;
                } catch (Exception e4) {
                    e4.printStackTrace();
                }
            }
