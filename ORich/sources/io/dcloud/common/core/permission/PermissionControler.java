...
public final class PermissionControler {
    ...
    public static boolean checkSafePermission(String str, String str2) {
        return "console".equals(str2) || "events".equals(str2.toLowerCase()) || "uninview".equals(str2.toLowerCase()) || "webview-x5".equals(str2.toLowerCase()) || "uiwebview".equals(str2.toLowerCase()) || "faceid".equals(str2.toLowerCase());
    }
    ...
    public static void runNextRequestPermission(Activity activity, int i) {
        ...
        runRequestPermissions(activity, first.f527a, first.b);
    }
