...
public class DCWeexBaseRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: io.dcloud.feature.weex.adapter.widget.refresh.DCWeexBaseRefreshLayout.7
            ...
            public void applyTransformation(float f, Transformation transformation) {
                ...
                if (!DCWeexBaseRefreshLayout.this.mUsingCustomStart) {
                    fAbs = DCWeexBaseRefreshLayout.this.mSpinnerFinalOffset - Math.abs(DCWeexBaseRefreshLayout.this.mOriginalOffsetTop);
                } else {
                    fAbs = DCWeexBaseRefreshLayout.this.mSpinnerFinalOffset;
                }
                DCWeexBaseRefreshLayout.this.setTargetOffsetTopAndBottom((DCWeexBaseRefreshLayout.this.mFrom + ((int) ((((int) fAbs) - DCWeexBaseRefreshLayout.this.mFrom) * f))) - DCWeexBaseRefreshLayout.this.mCircleView.getTop(), false);
    ...
    public void beginRefresh() {
        ...
        post(new Runnable() { // from class: io.dcloud.feature.weex.adapter.widget.refresh.DCWeexBaseRefreshLayout.2
            ...
            public void run() {
                if (this.offset < DCWeexBaseRefreshLayout.this.mTotalDragDistance) {
                    DCWeexBaseRefreshLayout.this.moveSpinner(this.offset);
