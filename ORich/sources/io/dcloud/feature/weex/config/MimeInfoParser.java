...
public class MimeInfoParser {
    ...
    final String FILE_TYPE_FLAG = Operators.DIV;
    ...
    private MimeInfo parseMimeInfo(String str) {
        ...
        if (!str.startsWith("data:") || !str.contains(Operators.DIV) || !str.contains(";") || !str.contains(",")) {
            return null;
        }
        String strSubstring = str.substring(5);
        String strSubstring2 = strSubstring.substring(0, strSubstring.indexOf(Operators.DIV));
        mimeInfo.fileType = strSubstring2;
        String strSubstring3 = strSubstring.substring((strSubstring2 + Operators.DIV).length());
