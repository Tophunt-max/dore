...
public class c implements SensorEventListener {
    ...
    void a(float f, float f2, float f3) {
        Deprecated_JSUtil.excCallbackSuccess(this.b, this.f696a, String.format(Locale.ENGLISH, "{alpha:%f,beta:%f,gamma:%f,magneticHeading:%f,trueHeading:%f,headingAccuracy:%f}", Float.valueOf(f), Float.valueOf(-f2), Float.valueOf(-f3), Float.valueOf(f), Float.valueOf(f), Float.valueOf(0.0f)), true, true);
    }

    void a(int i, String str) {
        b();
        Deprecated_JSUtil.excCallbackError(this.b, this.f696a, DOMException.toJSON(i, str), true);
    }
}
