...
public class b implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            this.d = 0.0f;
            this.c = 0.0f;
            float x2 = (this.f659a.getX() + x) - this.b.getPivotX();
            float y2 = (this.f659a.getY() + y) - this.b.getPivotY();
        ...
        float x3 = (this.f659a.getX() + fArr[0]) - this.b.getPivotX();
        float y3 = (this.f659a.getY() + fArr[1]) - this.b.getPivotY();
