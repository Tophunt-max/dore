...
public class a implements ISysEventListener {
    ...
    class C0050a implements Comparator<c> {
        C0050a(a aVar) {
        }
    ...
    private boolean a(String str, ISysEventListener.SysEventType sysEventType, String str2, int i, boolean z) {
        ...
        for (int i3 = i2; i3 >= 0; i3--) {
            ...
            if (cVar != null && cVar.f702a == null && ((cVar.p() || cVar.F) && cVar.y.getFrameType() != 6 && ((i2 == i3 && "back".equals(str) && cVar.c(str, str3, z)) || cVar.b(str, str3, z) || (!BaseInfo.USE_ACTIVITY_HANDLE_KEYEVENT && str2 != null && (cVar.b(str2) || (sysEventType == ISysEventListener.SysEventType.onKeyDown && ((cVar.b("back") && i == 4) || ((cVar.b(AbsoluteConst.EVENTS_MENU) && i == 82) || ((cVar.b(AbsoluteConst.EVENTS_VOLUME_DOWN) && i == 25) || ((cVar.b(AbsoluteConst.EVENTS_VOLUME_UP) && i == 24) || (cVar.b("search") && i == 84))))))))))) {
                return true;
            }
        }
        return false;
