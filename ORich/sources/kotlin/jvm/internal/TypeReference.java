...
public final class TypeReference implements KType {
    ...
    private final String asString() {
        ...
        return arrayClassName + (getArguments().isEmpty() ? "" : CollectionsKt.joinToString$default(getArguments(), ", ", Operators.L, Operators.G, 0, null, new Function1<KTypeProjection, CharSequence>() { // from class: kotlin.jvm.internal.TypeReference$asString$args$1
            {
                super(1);
            }
        ...
        }, 24, null)) + (getIsMarkedNullable() ? Operators.CONDITION_IF_STRING : "");
    }
