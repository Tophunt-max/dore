...
public final class DurationKt {
    ...
    private static final double m1331timesmvk6XK0(int i, double d) {
        return Duration.m1311timesUwyO8pc(d, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1330timeskIfJnKk(double d, double d2) {
        return Duration.m1310timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m1284constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
