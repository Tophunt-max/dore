...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1335copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1337copyRFiDyg4(obj, d);
    }
    ...
    public final TimedValue<T> m1337copyRFiDyg4(T value, double duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1322toStringimpl(this.duration) + Operators.BRACKET_END_STR;
    }
    ...
    public final double m1338getDurationUwyO8pc() {
        return this.duration;
    }
