...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> toUByteArray) {
        ...
        byte[] bArrM87constructorimpl = UByteArray.m87constructorimpl(toUByteArray.size());
        Iterator<UByte> it = toUByteArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UByteArray.m98setVurrAj0(bArrM87constructorimpl, i, it.next().getData());
            i++;
        }
        return bArrM87constructorimpl;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> toUIntArray) {
        ...
        int[] iArrM157constructorimpl = UIntArray.m157constructorimpl(toUIntArray.size());
        Iterator<UInt> it = toUIntArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UIntArray.m168setVXSXFK8(iArrM157constructorimpl, i, it.next().getData());
            i++;
        }
        return iArrM157constructorimpl;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> toULongArray) {
        ...
        long[] jArrM227constructorimpl = ULongArray.m227constructorimpl(toULongArray.size());
        Iterator<ULong> it = toULongArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            ULongArray.m238setk8EXiF4(jArrM227constructorimpl, i, it.next().getData());
            i++;
        }
        return jArrM227constructorimpl;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> toUShortArray) {
        ...
        short[] sArrM323constructorimpl = UShortArray.m323constructorimpl(toUShortArray.size());
        Iterator<UShort> it = toUShortArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UShortArray.m334set01HTLdE(sArrM323constructorimpl, i, it.next().getData());
            i++;
        }
        return sArrM323constructorimpl;
    }

    public static final int sumOfUInt(Iterable<UInt> sum) {
        Intrinsics.checkNotNullParameter(sum, "$this$sum");
        Iterator<UInt> it = sum.iterator();
        int iM112constructorimpl = 0;
        while (it.hasNext()) {
            iM112constructorimpl = UInt.m112constructorimpl(iM112constructorimpl + it.next().getData());
        }
        return iM112constructorimpl;
    }

    public static final long sumOfULong(Iterable<ULong> sum) {
        Intrinsics.checkNotNullParameter(sum, "$this$sum");
        Iterator<ULong> it = sum.iterator();
        long jM182constructorimpl = 0;
        while (it.hasNext()) {
            jM182constructorimpl = ULong.m182constructorimpl(jM182constructorimpl + it.next().getData());
        }
        return jM182constructorimpl;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> sum) {
        ...
        int iM112constructorimpl = 0;
        while (it.hasNext()) {
            iM112constructorimpl = UInt.m112constructorimpl(iM112constructorimpl + UInt.m112constructorimpl(it.next().getData() & 255));
        }
        return iM112constructorimpl;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> sum) {
        ...
        int iM112constructorimpl = 0;
        while (it.hasNext()) {
            iM112constructorimpl = UInt.m112constructorimpl(iM112constructorimpl + UInt.m112constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM112constructorimpl;
    }
}
