...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1192getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM182constructorimpl = ((int) ULong.m182constructorimpl(j ^ ULong.m182constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM182constructorimpl2 = (iM182constructorimpl + ((int) ULong.m182constructorimpl(j2 ^ ULong.m182constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM182constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m219toStringimpl(this.first));
            sb.append(PdrUtil.FILE_PATH_ENTRY_BACK);
            sb.append(ULong.m219toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1215fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
