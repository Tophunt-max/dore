...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static int m95hashCodeimpl(byte[] bArr) {
        if (bArr != null) {
    ...
    public static String m99toStringimpl(byte[] bArr) {
    ...
    public boolean m100add7apg3OU(byte b) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean m101contains7apg3OU(byte b) {
        return m89contains7apg3OU(this.storage, b);
    }

    @Override // java.util.Collection
    public boolean containsAll(Collection<? extends Object> collection) {
        return m90containsAllimpl(this.storage, collection);
    }

    @Override // java.util.Collection
    public boolean equals(Object other) {
        return m91equalsimpl(this.storage, other);
    }

    public int getSize() {
        return m94getSizeimpl(this.storage);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m95hashCodeimpl(this.storage);
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m96isEmptyimpl(this.storage);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public UByteIterator iterator() {
        return m97iteratorimpl(this.storage);
    }
    ...
    public String toString() {
        return m99toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m101contains7apg3OU(((UByte) obj).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static byte[] m87constructorimpl(int i) {
        return m88constructorimpl(new byte[i]);
    }

    /* JADX INFO: renamed from: get-w2LRezQ, reason: not valid java name */
    public static final byte m93getw2LRezQ(byte[] bArr, int i) {
        return UByte.m44constructorimpl(bArr[i]);
    }

    /* JADX INFO: renamed from: set-VurrAj0, reason: not valid java name */
    public static final void m98setVurrAj0(byte[] bArr, int i, byte b) {
        bArr[i] = b;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m94getSizeimpl(byte[] bArr) {
        return bArr.length;
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static UByteIterator m97iteratorimpl(byte[] bArr) {
    ...
    private static final class Iterator extends UByteIterator {
        ...
        public byte mo103nextUBytew2LRezQ() {
            int i = this.index;
    ...
    /* JADX INFO: renamed from: contains-7apg3OU, reason: not valid java name */
    public static boolean m89contains7apg3OU(byte[] bArr, byte b) {
        return ArraysKt.contains(bArr, b);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m90containsAllimpl(byte[] bArr, Collection<UByte> elements) {
    ...
    public static boolean m96isEmptyimpl(byte[] bArr) {
