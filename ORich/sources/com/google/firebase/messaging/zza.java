...
public final class zza {
    ...
    public final zzc zzf(Bundle bundle) {
        ...
        if (numZzl != null) {
            builder.setColor(numZzl.intValue());
        }
    ...
    public static boolean zzh(Bundle bundle) {
        return AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(zza(bundle, "gcm.n.e")) || zza(bundle, "gcm.n.icon") != null;
    }
    ...
    private final synchronized Bundle zzap() {
        ApplicationInfo applicationInfoZzc;
        Bundle bundle = this.zzdv;
        if (bundle != null) {
            return bundle;
        }
        try {
            applicationInfoZzc = zzc(128);
        } catch (PackageManager.NameNotFoundException e) {
            String strValueOf = String.valueOf(e);
            StringBuilder sb = new StringBuilder(String.valueOf(strValueOf).length() + 35);
            sb.append("Couldn't get own application info: ");
        ...
        if (applicationInfoZzc != null && applicationInfoZzc.metaData != null) {
            Bundle bundle2 = applicationInfoZzc.metaData;
            this.zzdv = bundle2;
            return bundle2;
        }
        return Bundle.EMPTY;
    ...
    private final String zzm(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            StringBuilder sb = new StringBuilder(String.valueOf(str).length() + CharsetProber.ASCII_Z);
    ...
    private static boolean zzk(Bundle bundle) {
        return bundle != null && AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(bundle.getString("google.c.a.e"));
    }
}
