...
final class zza extends AsyncTask<Void, Void, Integer> {
    ...
    protected final /* synthetic */ void onPostExecute(Integer num) {
        ...
        if (num2.intValue() == 0) {
            ...
            this.zzix.onProviderInstallFailed(num2.intValue(), ProviderInstaller.zziv.getErrorResolutionIntent(this.val$context, num2.intValue(), ContextChain.TAG_PRODUCT_AND_INFRA));
        }
    }
}
