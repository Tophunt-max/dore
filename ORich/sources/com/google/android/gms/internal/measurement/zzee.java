...
public final class zzee {
    ...
    public final Bundle zzc(Bundle bundle, boolean z) {
        ...
        if (z) {
            return zzbzVar.zzb(WebAppActivity.SPLASH_SECOND);
        }
        return null;
    }
    ...
    public final List<Bundle> zzp(String str, String str2) {
        ...
        List<Bundle> list = (List) zzbz.zze(zzbzVar.zzb(WebAppActivity.SPLASH_SECOND), List.class);
    ...
    public final Map<String, Object> zzq(String str, String str2, boolean z) {
        ...
        Bundle bundleZzb = zzbzVar.zzb(WebAppActivity.SPLASH_SECOND);
