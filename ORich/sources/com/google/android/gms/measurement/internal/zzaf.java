...
public final class zzaf extends zzgo {
    ...
    */
    ...
    public final boolean zzs(String str, zzdx<Boolean> zzdxVar) {
        ...
        return zzdxVar.zza(Boolean.valueOf(this.zzs.zzf().zzs(null, zzdy.zzaB) ? AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(strZza) : Boolean.parseBoolean(strZza))).booleanValue();
    }

    public final boolean zzt(String str) {
        return AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(this.zzb.zza(str, "gaia_collection_enabled"));
    }
    ...
    public final boolean zzw(String str) {
        return AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(this.zzb.zza(str, "measurement.event_sampling_enabled"));
    }
