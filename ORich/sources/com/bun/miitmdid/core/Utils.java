...
public class Utils {
    ...
    public static String getXdataDir(Context context, String str) {
        ...
        stringBuffer.append(String.valueOf(getUserDir(context)) + Operators.DIV + JLibrary.xdata + Operators.DIV + str);
        return stringBuffer.toString();
    }

    public static String getYdataDir(Context context, String str) {
        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append(String.valueOf(getUserDir(context)) + Operators.DIV + JLibrary.ydata + Operators.DIV + str);
        return stringBuffer.toString();
    }
