...
public class PreviewActivity extends FragmentActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void onPageSelected(int i) {
        this.bar_title.setText((i + 1) + Operators.DIV + this.preRawList.size());
    ...
    void setDoneView(int i) {
        ...
        this.done.setText(this.doneBtnText + Operators.BRACKET_START_STR + i + Operators.DIV + this.max + Operators.BRACKET_END_STR);
    }
