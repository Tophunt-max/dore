...
public final class DefaultDownloadDBController implements DownloadDBController {
    ...
    public static final String[] DOWNLOAD_INFO_COLUMNS = {"_id", "supportRanges", "createAt", "uri", FirebaseAnalytics.Param.LOCATION, AbsoluteConst.XML_PATH, AbsoluteConst.JSON_KEY_SIZE, "progress", "status"};
