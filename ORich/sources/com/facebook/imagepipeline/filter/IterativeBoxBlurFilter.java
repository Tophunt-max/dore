...
public abstract class IterativeBoxBlurFilter {
    ...
    public static void boxBlurBitmapInPlace(final Bitmap bitmap, final int iterations, final int radius) {
        ...
        try {
            ...
            FLog.e(TAG, String.format((Locale) null, "OOM: %d iterations on %dx%d with %d radius", Integer.valueOf(iterations), Integer.valueOf(bitmap.getWidth()), Integer.valueOf(bitmap.getHeight()), Integer.valueOf(radius)));
            throw e;
        }
    }
