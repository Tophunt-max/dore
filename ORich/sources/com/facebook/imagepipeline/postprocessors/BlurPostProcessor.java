...
public class BlurPostProcessor extends BasePostprocessor {
    ...
    public CacheKey getPostprocessorCacheKey() {
        ...
        if (this.mCacheKey == null) {
            if (canUseRenderScript) {
                str = String.format((Locale) null, "IntrinsicBlur;%d", Integer.valueOf(this.mBlurRadius));
            } else {
                str = String.format((Locale) null, "IterativeBoxBlur;%d;%d", Integer.valueOf(this.mIterations), Integer.valueOf(this.mBlurRadius));
            }
