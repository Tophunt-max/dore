...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(final InputStream is) throws IOException {
        ...
        int i2 = ((byte) is.read()) & 255;
        return new Pair<>(Integer.valueOf((i | ((i2 & 63) << 8)) + 1), Integer.valueOf(((((((byte) is.read()) & 255) & 15) << 10) | ((((byte) is.read()) & 255) << 2) | ((i2 & JfifUtil.MARKER_SOFn) >> 6)) + 1));
    }
