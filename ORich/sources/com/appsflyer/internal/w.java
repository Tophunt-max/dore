...
final class w {
    ...
    static final class e {
        static final w values = new w();
    }

    w() {
    }

    private static boolean valueOf(Context context, String[] strArr) {
    ...
    */
    final android.location.Location AFInAppEventParameterName(android.content.Context r9) {
        /*
            r8 = this;
            ...
            boolean r4 = valueOf(r9, r4)     // Catch: java.lang.Throwable -> L55
            if (r4 == 0) goto L1e
        ...
        L1f:
            ...
            boolean r9 = valueOf(r9, r0)     // Catch: java.lang.Throwable -> L55
            if (r9 == 0) goto L30
