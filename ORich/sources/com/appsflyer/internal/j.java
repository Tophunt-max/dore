...
public final class j {
    static final int AFInAppEventParameterName = (int) TimeUnit.SECONDS.toMillis(2);
    ...
    */
    final void values(java.util.Map<java.lang.String, java.lang.Object> r5, com.appsflyer.internal.au r6, android.content.Intent r7, android.content.Context r8) {
        /*
            r4 = this;
            ...
            r1 = 0
            int r5 = com.appsflyer.internal.ag.valueOf(r0, r5, r1)
            if (r5 != 0) goto L97
            boolean r5 = r0.getBoolean(r7, r1)
            if (r5 != 0) goto L97
    ...
    final void values(final Context context, final Map<String, Object> map, final Uri uri) {
            ...
            lVar.values.execute(new Runnable() { // from class: com.appsflyer.internal.j.3
                ...
                public final void run() {
                    ...
                    while (i < 5) {
                        ...
                        String str2 = (String) mapValues.get(UriUtil.LOCAL_RESOURCE_SCHEME);
                    ...
                    map2.put(UriUtil.LOCAL_RESOURCE_SCHEME, string != null ? string : "");
                ...
                private static Map<String, Object> values(Uri uri2) {
                    ...
                    try {
                        ...
                        if (300 <= responseCode && responseCode <= 305) {
                            map2.put(UriUtil.LOCAL_RESOURCE_SCHEME, httpURLConnection.getHeaderField("Location"));
                        }
