...
public final class ImageSizeUtils {
    ...
    /* JADX INFO: renamed from: com.nostra13.dcloudimageloader.utils.ImageSizeUtils$1, reason: invalid class name */
    ...
    public static ImageSize defineTargetSizeForView(ImageAware imageAware, ImageSize imageSize) {
        ...
        int width2 = width <= 0 ? imageSize.getWidth() : Math.min(width, imageSize.getWidth());
        int height = imageAware.getHeight();
        return new ImageSize(width2, height <= 0 ? imageSize.getHeight() : Math.min(height, imageSize.getHeight()));
    }
