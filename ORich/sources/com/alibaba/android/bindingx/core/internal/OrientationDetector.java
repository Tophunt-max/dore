...
class OrientationDetector implements SensorEventListener {
    ...
    private String getOrientationSensorTypeUsed() {
        ...
        return set == DEVICE_ORIENTATION_SENSORS_A ? "GAME_ROTATION_VECTOR" : set == DEVICE_ORIENTATION_SENSORS_B ? "ROTATION_VECTOR" : set == DEVICE_ORIENTATION_SENSORS_C ? "ACCELEROMETER_MAGNETIC" : "NOT_AVAILABLE";
    }
