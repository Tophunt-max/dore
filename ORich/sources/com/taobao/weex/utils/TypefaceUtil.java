...
public class TypefaceUtil {
    ...
    private static void downloadFontByNetwork(final String str, final String str2, final String str3) {
        ...
        iWXHttpAdapter.sendRequest(wXRequest, new IWXHttpAdapter.OnHttpListener() { // from class: com.taobao.weex.utils.TypefaceUtil.1
            ...
            @Override // com.taobao.weex.adapter.IWXHttpAdapter.OnHttpListener
            public void onHttpFinish(WXResponse wXResponse) throws Throwable {
                int i;
                FontDO fontDO;
                ...
                if (i >= 200 && i <= 299 && wXResponse.originalData != null) {
                    zSaveFile = WXFileUtils.saveFile(str2, wXResponse.originalData, WXEnvironment.getApplication());
                    if (zSaveFile) {
    ...
    private static String getFontCacheDir() {
        return WXEnvironment.getApplication().getCacheDir() + Operators.DIV + FONT_CACHE_DIR_NAME;
    }
}
