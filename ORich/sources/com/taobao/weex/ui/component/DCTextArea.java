...
public class DCTextArea extends DCWXInput {
    ...
    /* JADX INFO: renamed from: com.taobao.weex.ui.component.DCTextArea$2, reason: invalid class name */
        ...
        addTextChangedListener(new TextWatcher() { // from class: com.taobao.weex.ui.component.DCTextArea.3
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                if (DCTextArea.this.getHostView().getLineCount() != this.line) {
                    ...
                    float lineTop = DCTextArea.this.getHostView().getLayout().getLineTop(DCTextArea.this.getHostView().getLineCount()) + extendedPaddingTop;
