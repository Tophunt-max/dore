        ...
        if (jSONObject != null) {
            ...
            if (this.isNestParent) {
                ...
                if (this.mParentScrollListener == null) {
                    ...
                    RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() { // from class: com.taobao.weex.ui.view.listview.WXRecyclerView.1
            ...
            if (this.mChildScrollListener == null) {
                RecyclerView.OnScrollListener onScrollListener2 = new RecyclerView.OnScrollListener() { // from class: com.taobao.weex.ui.view.listview.WXRecyclerView.2
                    @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
                    public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                        if (i == 0) {
                            WXRecyclerView.this.mCurrentDy = 0;
                ...
                this.mChildScrollListener = onScrollListener2;
    ...
    public void dispatchChildFling() {
        ...
        if (isScrollEnd() && (i = this.velocityY) != 0) {
            ...
            if (splineFlingDistance > i2) {
                childFling(this.mFlingHelper.getVelocityByDistance(splineFlingDistance - ((double) i2)));
            }
        }
        this.totalDy = 0;
        this.velocityY = 0;
