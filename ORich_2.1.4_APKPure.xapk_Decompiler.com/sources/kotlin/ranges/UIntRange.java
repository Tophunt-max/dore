...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1210containsWZ4Q5Ns(((UInt) comparable).getData());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return UInt.m106boximpl(m1211getEndInclusivepVg5ArA());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return UInt.m106boximpl(m1212getStartpVg5ArA());
    }

    /* JADX INFO: renamed from: getStart-pVg5ArA, reason: not valid java name */
    public int m1212getStartpVg5ArA() {
        return getFirst();
    }

    /* JADX INFO: renamed from: getEndInclusive-pVg5ArA, reason: not valid java name */
    public int m1211getEndInclusivepVg5ArA() {
        return getLast();
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m1210containsWZ4Q5Ns(int value) {
    ...
    public String toString() {
        return UInt.m149toStringimpl(getFirst()) + PdrUtil.FILE_PATH_ENTRY_BACK + UInt.m149toStringimpl(getLast());
    }
