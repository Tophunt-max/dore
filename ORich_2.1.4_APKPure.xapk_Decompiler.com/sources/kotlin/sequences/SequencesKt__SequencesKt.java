...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C01041<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        C01041(Sequence sequence, Function0 function0, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C01041 c01041 = new C01041(this.$this_ifEmpty, this.$defaultValue, completion);
            c01041.p$ = (SequenceScope) obj;
            return c01041;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> ifEmpty, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C01041(ifEmpty, defaultValue, null));
    }
    ...
    static final class C01051<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01051(Sequence sequence, Random random, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C01051 c01051 = new C01051(this.$this_shuffled, this.$random, completion);
            c01051.p$ = (SequenceScope) obj;
            return c01051;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C01051) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> shuffled, Random random) {
        ...
        return SequencesKt.sequence(new C01051(shuffled, random, null));
    }
    ...
    @DebugMetadata(c = "kotlin.sequences.SequencesKt__SequencesKt$flatMapIndexed$1", f = "Sequences.kt", i = {0, 0, 0, 0}, l = {332}, m = "invokeSuspend", n = {"$this$sequence", "index", BindingXConstants.KEY_ELEMENT, "result"}, s = {"L$0", "I$0", "L$1", "L$3"})
    static final class C01001<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01001(Sequence sequence, Function2 function2, Function1 function1, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C01001 c01001 = new C01001(this.$source, this.$transform, this.$iterator, completion);
            c01001.p$ = (SequenceScope) obj;
            return c01001;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C01001) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        return SequencesKt.sequence(new C01001(source, transform, iterator, null));
    }
