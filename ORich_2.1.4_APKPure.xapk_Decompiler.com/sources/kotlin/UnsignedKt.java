...
public final class UnsignedKt {
    ...
    public static final int m341uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m112constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m342uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m112constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m343ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? ULong.m182constructorimpl(0L) : ULong.m182constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m182constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m182constructorimpl(j3 + ((long) (ulongCompare(ULong.m182constructorimpl(j - (j3 * j2)), ULong.m182constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m344ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? j : ULong.m182constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m182constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (ulongCompare(ULong.m182constructorimpl(j3), ULong.m182constructorimpl(j2)) < 0) {
            j2 = 0;
        }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= d2) {
            return UInt.m112constructorimpl((int) d);
        }
        return UInt.m112constructorimpl(UInt.m112constructorimpl((int) (d - d2)) + UInt.m112constructorimpl(Integer.MAX_VALUE));
    }
