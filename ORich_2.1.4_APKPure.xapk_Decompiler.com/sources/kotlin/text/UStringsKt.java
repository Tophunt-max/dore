...
public final class UStringsKt {
    ...
    public static final String m1274toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1276toStringolVBNx4(short s, int i) {
    ...
    public static final String m1275toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1273toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m112constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m112constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m274boximpl(UShort.m280constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int iM112constructorimpl = UInt.m112constructorimpl(i);
        int iM341uintDivideJ1ME1BU = 119304647;
        while (i3 < length) {
            int iDigitOf = CharsKt.digitOf(toUIntOrNull.charAt(i3), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.uintCompare(i2, iM341uintDivideJ1ME1BU) > 0) {
                if (iM341uintDivideJ1ME1BU == 119304647) {
                    iM341uintDivideJ1ME1BU = UnsignedKt.m341uintDivideJ1ME1BU(-1, iM112constructorimpl);
                    if (UnsignedKt.uintCompare(i2, iM341uintDivideJ1ME1BU) > 0) {
                    }
                }
                return null;
            }
            int iM112constructorimpl2 = UInt.m112constructorimpl(i2 * iM112constructorimpl);
            int iM112constructorimpl3 = UInt.m112constructorimpl(UInt.m112constructorimpl(iDigitOf) + iM112constructorimpl2);
            if (UnsignedKt.uintCompare(iM112constructorimpl3, iM112constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = iM112constructorimpl3;
        }
        return UInt.m106boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long jM182constructorimpl = ULong.m182constructorimpl(i);
        long j2 = 0;
        long jM343ulongDivideeb3DHEI = 512409557603043100L;
        while (i2 < length) {
            int iDigitOf = CharsKt.digitOf(toULongOrNull.charAt(i2), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.ulongCompare(j2, jM343ulongDivideeb3DHEI) > 0) {
                if (jM343ulongDivideeb3DHEI == 512409557603043100L) {
                    jM343ulongDivideeb3DHEI = UnsignedKt.m343ulongDivideeb3DHEI(j, jM182constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, jM343ulongDivideeb3DHEI) > 0) {
                    }
                }
                return null;
            }
            long jM182constructorimpl2 = ULong.m182constructorimpl(j2 * jM182constructorimpl);
            long jM182constructorimpl3 = ULong.m182constructorimpl(ULong.m182constructorimpl(((long) UInt.m112constructorimpl(iDigitOf)) & 4294967295L) + jM182constructorimpl2);
            if (UnsignedKt.ulongCompare(jM182constructorimpl3, jM182constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = jM182constructorimpl3;
            j = -1;
        }
        return ULong.m176boximpl(j2);
    }
}
