...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String toRelativeString(File toRelativeString, File base) {
        ...
        throw new IllegalArgumentException("this and base files have different roots: " + toRelativeString + " and " + base + Operators.DOT);
    }
    ...
    private static final List<File> normalize$FilesKt__UtilsKt(List<? extends File> list) {
        ...
        for (File file : list) {
            ...
            if (name != null) {
                ...
                if (iHashCode == 46) {
                    if (name.equals(Operators.DOT_STR)) {
                    }
                } else if (iHashCode == 1472 && name.equals(PdrUtil.FILE_PATH_ENTRY_BACK)) {
