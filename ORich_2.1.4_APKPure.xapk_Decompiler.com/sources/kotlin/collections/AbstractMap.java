...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public String toString() {
        return CollectionsKt.joinToString$default(entrySet(), ", ", Operators.BLOCK_START_STR, Operators.BLOCK_END_STR, 0, null, new Function1<Map.Entry<? extends K, ? extends V>, CharSequence>() { // from class: kotlin.collections.AbstractMap.toString.1
            {
                super(1);
            }
