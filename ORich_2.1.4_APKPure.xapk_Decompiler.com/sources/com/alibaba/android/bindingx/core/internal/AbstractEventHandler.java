...
public abstract class AbstractEventHandler implements IEventHandler {
    ...
    private void transformArgs(String str, List<Map<String, Object>> list) throws JSONException {
    ...
    public void performInterceptIfNeeded(String str, ExpressionPair expressionPair, Map<String, Object> map) {
        if (ExpressionPair.isValid(expressionPair)) {
            ...
            try {
                zBooleanValue = ((Boolean) expression.execute(map)).booleanValue();
            } catch (Exception e) {
                ...
                if (str.equals(expressionHolder.eventType)) {
                    ...
                    if (ExpressionPair.isValid(expressionPair)) {
                        ...
                        if (objExecute == null) {
                            ...
                            objArr2[1] = str2;
                            bindingXPropertyInterceptor.performIntercept(viewFindViewBy, str3, objExecute, resolutionTranslator, map4, objArr2);
