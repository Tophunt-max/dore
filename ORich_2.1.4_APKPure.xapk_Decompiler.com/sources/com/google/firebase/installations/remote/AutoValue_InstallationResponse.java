...
final class AutoValue_InstallationResponse extends InstallationResponse {
    ...
    public String toString() {
        return "InstallationResponse{uri=" + this.uri + ", fid=" + this.fid + ", refreshToken=" + this.refreshToken + ", authToken=" + this.authToken + ", responseCode=" + this.responseCode + Operators.BLOCK_END_STR;
    }
