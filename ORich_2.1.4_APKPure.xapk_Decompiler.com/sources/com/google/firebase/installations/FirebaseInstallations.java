...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.-$$Lambda$FirebaseInstallations$eaLCK67D8Fb7nKlx6_m7igW5oxM
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.-$$Lambda$FirebaseInstallations$i0IwN5aIp7QK3OfW8Xr4QToHfTU
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void lambda$getToken$1$FirebaseInstallations(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.-$$Lambda$FirebaseInstallations$VZq1h0TBcWNH8Y5yY86ujrFFyLo
            @Override // java.lang.Runnable
            public final void run() {
