...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Notification {
        ...
        private static String[] zzf(Bundle bundle, String str) {
            Object[] objArrZzb = zza.zzb(bundle, str);
            if (objArrZzb == null) {
                return null;
            }
    ...
    public final int getPriority() {
        ...
        if (string == null) {
            if (AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(this.zzeh.getString("google.priority_reduced"))) {
                return 2;
            }
            string = this.zzeh.getString("google.priority");
        }
