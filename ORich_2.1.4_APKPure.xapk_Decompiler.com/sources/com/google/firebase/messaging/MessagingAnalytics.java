...
public class MessagingAnalytics {
    ...
    public static void logNotificationOpen(Intent intent) {
        if (intent != null) {
            if (AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(intent.getStringExtra("google.c.a.tc"))) {
    ...
    public static boolean shouldUploadMetrics(Intent intent) {
        ...
        return AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT.equals(intent.getStringExtra("google.c.a.e"));
    }
