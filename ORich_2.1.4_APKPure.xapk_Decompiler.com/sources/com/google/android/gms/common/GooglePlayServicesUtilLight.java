...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        return PlatformVersion.isAtLeastJellyBeanMR2() && (applicationRestrictions = ((UserManager) context.getSystemService("user")).getApplicationRestrictions(context.getPackageName())) != null && AbsoluteConst.TRUE.equals(applicationRestrictions.getString("restricted_profile"));
    }
}
