    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (i2 == 0) {
            ...
            while (i8 <= 32) {
                ...
                if (size2 <= i11) {
                    ...
                    int i13 = i11 - (i11 % i9);
                    if ((!z2 || bitArrayStuffBits2.getSize() <= i9 * 64) && bitArrayStuffBits2.getSize() + size <= i13) {
        ...
        if (z) {
            ...
            for (int i21 = 0; i21 < i19; i21++) {
                ...
                iArr2[i19 + i21] = (i21 / 15) + i21 + i20 + i7;
            }
        }
            ...
            while (i26 < i25) {
                ...
                while (i6 < i17) {
                    if (bitArrayGenerateCheckWords.get(i23 + i27 + i6)) {
                        int i28 = i22 * 2;
                        bitMatrix.set(iArr2[i28 + i6], iArr2[i28 + i26]);
                    }
                    if (bitArrayGenerateCheckWords.get((i25 * 2) + i23 + i27 + i6)) {
                        int i29 = i22 * 2;
                        bitMatrix.set(iArr2[i29 + i26], iArr2[((i16 - 1) - i29) - i6]);
                    }
                    if (bitArrayGenerateCheckWords.get((i25 * 4) + i23 + i27 + i6)) {
                        int i30 = (i16 - 1) - (i22 * 2);
                        bitMatrix.set(iArr2[i30 - i6], iArr2[i30 - i26]);
                    }
                    if (bitArrayGenerateCheckWords.get((i25 * 6) + i23 + i27 + i6)) {
                        int i31 = i22 * 2;
                        bitMatrix.set(iArr2[((i16 - 1) - i31) - i26], iArr2[i31 + i6]);
                    }
                    i6++;
                    i17 = 2;
                }
