...
final class LoadAndDisplayImageTask implements Runnable {
    ...
    private boolean downloadSizedImage(File file, int i, int i2) throws IOException {
        ...
        try {
            ...
            boolean zCompress = bitmapDecode.compress(imageLoaderConfiguration.imageCompressFormatForDiscCache, imageLoaderConfiguration.imageQualityForDiscCache, bufferedOutputStream);
            IoUtils.closeSilently(bufferedOutputStream);
