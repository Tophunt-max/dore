...
public class ActionGetComponentRect extends BasicGraphicAction {
    ...
    private void callbackViewport(WXSDKInstance wXSDKInstance, JSCallback jSCallback) {
        ...
        if (containerView != null) {
            ...
            map2.put("left", Float.valueOf(0.0f));
            map2.put("top", Float.valueOf(0.0f));
            map2.put("right", Float.valueOf(getWebPxValue(containerView.getWidth(), instanceViewPortWidthWithFloat)));
            map2.put("bottom", Float.valueOf(getWebPxValue(containerView.getHeight(), instanceViewPortWidthWithFloat)));
            map2.put("width", Float.valueOf(getWebPxValue(containerView.getWidth(), instanceViewPortWidthWithFloat)));
            map2.put("height", Float.valueOf(getWebPxValue(containerView.getHeight(), instanceViewPortWidthWithFloat)));
            map.put(AbsoluteConst.JSON_KEY_SIZE, map2);
            map.put("result", true);
        ...
        map3.put(IWXUserTrackAdapter.MONITOR_ERROR_MSG, "Component does not exist");
