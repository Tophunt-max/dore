...
public class Statements {
    ...
    private static final WXComponent copyComponentTree(WXComponent wXComponent, WXVContainer wXVContainer) {
        BasicComponentData basicComponentDataMo13clone;
        try {
            basicComponentDataMo13clone = wXComponent.getBasicComponentData().mo13clone();
        } catch (CloneNotSupportedException e) {
            e.printStackTrace();
            basicComponentDataMo13clone = null;
        }
        WXComponent wXComponentNewInstance = WXComponentFactory.newInstance(wXComponent.getInstance(), wXVContainer, basicComponentDataMo13clone);
    ...
    */
    private static final int doRenderComponent(com.taobao.weex.ui.component.WXComponent r25, com.taobao.weex.ui.component.list.template.CellRenderContext r26, java.util.List<com.taobao.weex.ui.component.WXComponent> r27) {
        /*
