    ...
    public void showConfirm(boolean z, int i) {
        try {
            ...
            if (viewFindViewWithTag != null) {
                FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) viewFindViewWithTag.getLayoutParams();
                    ...
                    public void onClick(View view) {
                        if (ConfirmBar.this.editText.size() > 0) {
                            ...
                            while (true) {
                                ...
                                if ((wXComponent2.getHostView() instanceof WXEditText) && wXComponent2.getHostView().hasFocus()) {
