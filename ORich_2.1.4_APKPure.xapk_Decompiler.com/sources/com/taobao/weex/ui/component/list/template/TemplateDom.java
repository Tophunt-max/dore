...
public class TemplateDom {
    ...
    public static WXComponent findVirtualComponentByVRef(String str, String str2) {
        try {
            ...
            WXComponent wXComponent = WXSDKManager.getInstance().getWXRenderManager().getWXComponent(str, strArrSplit[0]);
            ...
            if (wXRecyclerTemplateList.getHostView() != 0 && ((BounceRecyclerView) wXRecyclerTemplateList.getHostView()).getInnerView() != null) {
                TemplateViewHolder templateViewHolder = (TemplateViewHolder) ((WXRecyclerView) ((BounceRecyclerView) wXRecyclerTemplateList.getHostView()).getInnerView()).findViewHolderForAdapterPosition(Integer.parseInt(strArrSplit[1]));
