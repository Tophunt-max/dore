...
public class TemplateStickyHelper {
    ...
    public void onBeforeScroll(int i, int i2) {
        ...
        if (iFindFirstVisibleItemPosition >= 0 && (templateViewHolder = (TemplateViewHolder) recyclerView.findViewHolderForAdapterPosition(iFindFirstVisibleItemPosition)) != null) {
            int iMax = -1;
            ...
            if (!(childAt3.getTag() instanceof TemplateViewHolder) || ((TemplateViewHolder) childAt3.getTag()).getHolderPosition() != iMax) {
                ...
                if (templateViewHolderOnCreateViewHolder == null) {
                    templateViewHolderOnCreateViewHolder = this.recyclerTemplateList.onCreateViewHolder((ViewGroup) recyclerView, itemViewType);
            ...
            for (int i5 = 0; i5 < recyclerView.getChildCount(); i5++) {
                ...
                TemplateViewHolder templateViewHolder6 = (TemplateViewHolder) recyclerView.getChildViewHolder(childAt4);
            ...
            TemplateViewHolder templateViewHolder7 = (TemplateViewHolder) recyclerView.findViewHolderForAdapterPosition(i6);
