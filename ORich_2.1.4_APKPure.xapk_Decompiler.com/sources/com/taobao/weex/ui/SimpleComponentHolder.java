...
public class SimpleComponentHolder implements IFComponentHolder {
    ...
    public static class ClazzComponentCreator implements ComponentCreator {
        ...
        public WXComponent createInstance(WXSDKInstance wXSDKInstance, WXVContainer wXVContainer, BasicComponentData basicComponentData) throws IllegalAccessException, InstantiationException, InvocationTargetException {
            ...
            if (length == 3) {
                return constructor.newInstance(wXSDKInstance, wXVContainer, basicComponentData);
            }
            return length == 4 ? constructor.newInstance(wXSDKInstance, wXVContainer, false, basicComponentData) : constructor.newInstance(wXSDKInstance, wXVContainer, wXSDKInstance.getInstanceId(), Boolean.valueOf(wXVContainer.isLazy()));
        }
    }
    ...
    @Override // com.taobao.weex.ui.ComponentCreator
    public synchronized WXComponent createInstance(WXSDKInstance wXSDKInstance, WXVContainer wXVContainer, BasicComponentData basicComponentData) throws IllegalAccessException, InstantiationException, InvocationTargetException {
