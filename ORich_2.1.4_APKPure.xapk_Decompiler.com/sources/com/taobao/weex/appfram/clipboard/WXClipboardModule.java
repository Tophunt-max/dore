...
public class WXClipboardModule extends WXModule implements IWXClipboard {
    ...
    /* JADX WARN: Removed duplicated region for block: B:73:0x006a A[EXC_TOP_SPLITTER, PHI: r7
      0x006a: PHI (r7v7 ??) = (r7v6 ??), (r7v9 ??) binds: [B:37:0x0068, B:54:0x0085] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    ...
    */
    private java.lang.CharSequence coerceToText(android.content.Context r7, android.content.ClipData.Item r8) throws java.lang.Throwable {
        /*
            r6 = this;
