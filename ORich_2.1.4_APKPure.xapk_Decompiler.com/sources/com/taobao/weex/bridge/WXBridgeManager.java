...
public class WXBridgeManager implements Handler.Callback, BactchExecutor {
    ...
    public void setSandBoxContext(boolean z) {
        ...
        if (z != isSandBoxContext) {
            ...
            if (isJSThread()) {
                ...
                if (!isSandBoxContext) {
                    strLoadAsset = WXFileUtils.loadAsset("main.js", WXEnvironment.getApplication());
                } else {
                    strLoadAsset = WXFileUtils.loadAsset("weex-main-jsfm.js", WXEnvironment.getApplication());
                }
                initFramework(strLoadAsset);
            ...
            post(new Runnable() { // from class: com.taobao.weex.bridge.WXBridgeManager.3
                @Override // java.lang.Runnable
                public void run() {
                    String strLoadAsset2;
                    WXBridgeManager.this.setJSFrameworkInit(false);
                    WXModuleManager.resetAllModuleState();
                    if (!WXBridgeManager.isSandBoxContext) {
                        strLoadAsset2 = WXFileUtils.loadAsset("main.js", WXEnvironment.getApplication());
                    } else {
                        strLoadAsset2 = WXFileUtils.loadAsset("weex-main-jsfm.js", WXEnvironment.getApplication());
                    }
                    WXBridgeManager.this.initFramework(strLoadAsset2);
                    WXServiceManager.reload();
                    WXModuleManager.reload();
                    WXComponentRegistry.reload();
                }
    ...
    */
    ...
    void setTimeout(String str, String str2) {
        ...
        this.mJSHandler.sendMessageDelayed(messageObtain, timerInfo.time);
    }
    ...
    public int callReportCrashReloadPage(String str, String str2) {
        ...
        try {
            ...
            if (!zIsEmpty) {
                ...
                wXStateRecord.onJSCCrash(str4);
                callReportCrash(str2, str, str3, map);
            } else {
                WXStateRecord wXStateRecord2 = WXStateRecord.getInstance();
                if (!TextUtils.isEmpty(str)) {
                    str4 = str;
                }
                wXStateRecord2.onJSEngineReload(str4);
        ...
        try {
            ...
            WXExceptionUtils.commitCriticalExceptionRT(str, WXErrorCode.WX_KEY_EXCEPTION_INVOKE_BRIDGE, "callReportCrashReloadPage", WXLogUtils.getStackTrace(e2), null);
        }
        return 0;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:61:0x0123 A[Catch: all -> 0x02c2, TRY_ENTER, TryCatch #0 {all -> 0x02c2, blocks: (B:15:0x0047, B:51:0x00f1, B:53:0x010c, B:55:0x0112, B:57:0x011b, B:62:0x0127, B:66:0x0135, B:70:0x0145, B:72:0x014c, B:75:0x0155, B:85:0x0186, B:87:0x018e, B:94:0x01c7, B:97:0x01f1, B:99:0x0223, B:101:0x0227, B:103:0x022b, B:105:0x0233, B:107:0x023b, B:110:0x0244, B:112:0x0259, B:114:0x0270, B:88:0x019a, B:90:0x01a2, B:91:0x01b4, B:93:0x01bc, B:76:0x015b, B:78:0x015f, B:80:0x0165, B:81:0x016b, B:83:0x0173, B:84:0x017f, B:65:0x0131, B:61:0x0123, B:50:0x00ea, B:21:0x0086, B:16:0x0049, B:18:0x005f), top: B:119:0x0047, inners: #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:64:0x012f  */
    /* JADX WARN: Removed duplicated region for block: B:65:0x0131 A[Catch: all -> 0x02c2, TryCatch #0 {all -> 0x02c2, blocks: (B:15:0x0047, B:51:0x00f1, B:53:0x010c, B:55:0x0112, B:57:0x011b, B:62:0x0127, B:66:0x0135, B:70:0x0145, B:72:0x014c, B:75:0x0155, B:85:0x0186, B:87:0x018e, B:94:0x01c7, B:97:0x01f1, B:99:0x0223, B:101:0x0227, B:103:0x022b, B:105:0x0233, B:107:0x023b, B:110:0x0244, B:112:0x0259, B:114:0x0270, B:88:0x019a, B:90:0x01a2, B:91:0x01b4, B:93:0x01bc, B:76:0x015b, B:78:0x015f, B:80:0x0165, B:81:0x016b, B:83:0x0173, B:84:0x017f, B:65:0x0131, B:61:0x0123, B:50:0x00ea, B:21:0x0086, B:16:0x0049, B:18:0x005f), top: B:119:0x0047, inners: #1 }] */
    /* JADX WARN: Removed duplicated region for block: B
inners: #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:97:0x01f1 A[Catch: all -> 0x02c2, TRY_ENTER, TryCatch #0 {all -> 0x02c2, blocks: (B:15:0x0047, B:51:0x00f1, B:53:0x010c, B:55:0x0112, B:57:0x011b, B:62:0x0127, B:66:0x0135, B:70:0x0145, B:72:0x014c, B:75:0x0155, B:85:0x0186, B:87:0x018e, B:94:0x01c7, B:97:0x01f1, B:99:0x0223, B:101:0x0227, B:103:0x022b, B:105:0x0233, B:107:0x023b, B:110:0x0244, B:112:0x0259, B:114:0x0270, B:88:0x019a, B:90:0x01a2, B:91:0x01b4, B:93:0x01bc, B:76:0x015b, B:78:0x015f, B:80:0x0165, B:81:0x016b, B:83:0x0173, B:84:0x017f, B:65:0x0131, B:61:0x0123, B:50:0x00ea, B:21:0x0086, B:16:0x0049, B:18:0x005f), top: B:119:0x0047, inners: #1 }] */
    /* JADX WARN: Removed duplicated region for block: B:99:0x0223 A[Catch: all -> 0x02c2, TryCatch #0 {all -> 0x02c2, blocks: (B:15:0x0047, B:51:0x00f1, B:53:0x010c, B:55:0x0112, B:57:0x011b, B:62:0x0127, B:66:0x0135, B:70:0x0145, B:72:0x014c, B:75:0x0155, B:85:0x0186, B:87:0x018e, B:94:0x01c7, B:97:0x01f1, B:99:0x0223, B:101:0x0227, B:103:0x022b, B:105:0x0233, B:107:0x023b, B:110:0x0244, B:112:0x0259, B:114:0x0270, B:88:0x019a, B:90:0x01a2, B:91:0x01b4, B:93:0x01bc, B:76:0x015b, B:78:0x015f, B:80:0x0165, B:81:0x016b, B:83:0x0173, B:84:0x017f, B:65:0x0131, B:61:0x0123, B:50:0x00ea, B:21:0x0086, B:16:0x0049, B:18:0x005f), top: B:119:0x0047, inners: #1 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public void invokeExecJS(final String str, final String str2, final String str3, final WXJSObject[] wXJSObjectArr, boolean z) {
        ...
        if (RuningAcitvityUtil.isRuningActivity) {
            ...
            if (sDKInstance != null && sDKInstance.getRenderStrategy() == WXRenderStrategy.DATA_RENDER_BINARY) {
                if (wXJSObjectArr.length != 2 || !(wXJSObjectArr[0].data instanceof String) || !(wXJSObjectArr[1].data instanceof String) || (pairExtractCallbackArgs = extractCallbackArgs((String) wXJSObjectArr[1].data)) == null) {
                    WXLogUtils.w("invokeExecJS on data render that is not a callback call");
                    return;
                }
                callbackJavascriptOnDataRender(str, (String) ((Pair) pairExtractCallbackArgs.first).first, ((Pair) pairExtractCallbackArgs.first).second, ((Boolean) pairExtractCallbackArgs.second).booleanValue());
            } else {
    ...
    public void initFramework(String str) {
        ...
        try {
            ...
            sb2.append(z);
            WXLogUtils.d("[WXBridgeManager] initFrameworkEnv crashFile:" + path + " pieSupport:" + z);
            LogDetail logDetail3 = new LogDetail();
            logDetail3.name("native initFrameworkEnv");
            logDetail3.taskStart();
            if (this.mWXBridge.initFrameworkEnv(str, assembleDefaultOptions(), path, z) == 1) {
                logDetail3.taskEnd();
    ...
    public void invokeExecJSService(String str, List<String> list) {
        try {
            ...
            WXExceptionUtils.commitCriticalExceptionRT("invokeExecJSService", WXErrorCode.WX_KEY_EXCEPTION_INVOKE_JSSERVICE_EXECUTE, "invokeExecJSService", WXErrorCode.WX_KEY_EXCEPTION_INVOKE_JSSERVICE_EXECUTE.getErrorMsg() + "[WXBridgeManager] invokeRegisterService:" + WXLogUtils.getStackTrace(th), map);
        }
    }
