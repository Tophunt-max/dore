        ...
        for (ColorConvertHandler colorConvertHandler : ColorConvertHandler.values()) {
            try {
                ...
                if (((Boolean) pairHandle.first).booleanValue()) {
                    i = ((Integer) pairHandle.second).intValue();
                    WXUtils.sCache.put(strTrim, Integer.valueOf(i));
                    break;
                }
                continue;
    ...
    */
    private static float[] parseGradientDirection(java.lang.String r8, float r9, float r10) {
        /*
            ...
            r1 = {x00ac: FILL_ARRAY_DATA , data: [0, 0, 0, 0} // fill-array
        ...
        L18:
            ...
            r7 = 0
            switch(r3) {
                case -1352032154: goto L5e;
                case -1137407871: goto L53;
                case -868157182: goto L48;
                case -172068863: goto L3d;
                case 110550266: goto L34;
    ...
    enum ColorConvertHandler {
        ...
        FUNCTIONAL_RGB_HANDLER { // from class: com.taobao.weex.utils.WXResourceUtils.ColorConvertHandler.3
            ...
            Pair<Boolean, Integer> handle(String str) {
                ...
                if (list != null && list.size() == 3) {
                    return new Pair<>(Boolean.TRUE, Integer.valueOf(Color.rgb(((Integer) list.get(0)).intValue(), ((Integer) list.get(1)).intValue(), ((Integer) list.get(2)).intValue())));
                }
                return new Pair<>(Boolean.FALSE, 0);
            }
        },
        FUNCTIONAL_RGBA_HANDLER { // from class: com.taobao.weex.utils.WXResourceUtils.ColorConvertHandler.4
            ...
            Pair<Boolean, Integer> handle(String str) {
                ...
                if (list.size() == 4) {
                    return new Pair<>(Boolean.TRUE, Integer.valueOf(Color.argb(ColorConvertHandler.parseAlpha(((Number) list.get(3)).floatValue()), ((Number) list.get(0)).intValue(), ((Number) list.get(1)).intValue(), ((Number) list.get(2)).intValue())));
                }
                return new Pair<>(Boolean.FALSE, 0);
            }
        };
