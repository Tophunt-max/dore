...
public class o extends e {
    private static final String m = "com.igexin.push.e.c.o";
    ...
    public void a(byte[] bArr) {
        int i;
        int i2;
        this.f279a = com.igexin.b.a.b.f.c(bArr, 0);
        this.b = bArr[2] & 192;
        this.h = a(bArr[2]);
        ...
        if (bArr.length > i10) {
            try {
                this.g = new String(bArr, i10 + 1, bArr[i10] & 255, this.h);
    ...
    public byte[] d() {
        ...
        try {
            ...
            int iB = com.igexin.b.a.b.f.b(this.f279a, bArr, 0);
