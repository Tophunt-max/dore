...
public class a {
    ...
    static class C0080a {
        ...
        public JSONObject a() {
            try {
                return new JSONObject(String.format(Locale.ENGLISH, "{lastModifiedDate : %d,size : %d,directoryCount : %d,fileCount : %d}", Long.valueOf(this.f830a), Long.valueOf(this.b), Integer.valueOf(this.c), Integer.valueOf(this.d)));
    ...
    public static JSONObject a(String str, boolean z) {
        ...
        c0080a.f830a = file.lastModified();
        if (file.isDirectory()) {
            ...
            c0080a.b = file.length();
        }
        return c0080a.a();
    }

    public static void a(File file, C0080a c0080a, boolean z) {
