...
public class ValueAnimator extends Animator {
    ...
    public ValueAnimator m17clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.m17clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderM21clone = propertyValuesHolderArr[i2].m21clone();
                valueAnimator.mValues[i2] = propertyValuesHolderM21clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderM21clone.getPropertyName(), propertyValuesHolderM21clone);
            }
        }
        return valueAnimator;
    }
