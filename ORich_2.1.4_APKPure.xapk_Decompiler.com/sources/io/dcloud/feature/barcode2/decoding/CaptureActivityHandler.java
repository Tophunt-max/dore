...
public final class CaptureActivityHandler extends Handler {
    ...
    public static Result tryBiggerBitmap(Bitmap bitmap, boolean z) {
        ...
        if (width < 1200 && height < 1200) {
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(width + ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, height + ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, Bitmap.Config.ARGB_8888);
