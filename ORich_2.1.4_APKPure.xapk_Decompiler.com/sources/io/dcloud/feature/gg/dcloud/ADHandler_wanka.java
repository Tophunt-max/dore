...
class ADHandler_wanka extends ADHandler {
    ...
    public static void checkRunLoad(final Context context, final JSONObject jSONObject, int i) {
        ...
        new Timer().schedule(new TimerTask() { // from class: io.dcloud.feature.gg.dcloud.ADHandler_wanka.1
            ...
            public void run() {
                ...
                JSONArray jSONArrayOptJSONArray = jSONObject.optJSONObject("report").optJSONArray("actvtrackers");
                if (jSONArrayOptJSONArray != null) {
                    ADHandler_wanka.handleTrackers_wanka(jSONArrayOptJSONArray, jSONObject, "actvtrackers");
                } else {
    ...
    static void click_wanka(final Context context, final ADHandler.AdData adData, final String str) {
        ...
        String strOptString = adData.data().optString(PushConsts.CMD_ACTION);
        if (iOptInt == 1) {
            if (adData.isEClick()) {
                return;
            }
            ...
            if (AbsoluteConst.SPNAME_DOWNLOAD.equals(strOptString)) {
                handleTrackers_wanka(jSONArrayOptJSONArray, adData.full(), new ICallBack() { // from class: io.dcloud.feature.gg.dcloud.ADHandler_wanka.2
    ...
    public static void click_wanka_other(Context context, ADHandler.AdData adData, String str, String str2, String str3, String str4, final JSONObject jSONObject) {
        ...
        if (adData.isEClick()) {
            ADSim.dwApp(context, str2, str3, str4, str, strOptString, new ILoadCallBack() { // from class: io.dcloud.feature.gg.dcloud.ADHandler_wanka.6
        ...
        long jLoadADFile = ADUtils.loadADFile(context, str2, str3, str4, fileNameByUrl, strOptString, str, "application/vnd.android", new ILoadCallBack() { // from class: io.dcloud.feature.gg.dcloud.ADHandler_wanka.7
            @Override // io.dcloud.common.DHInterface.ILoadCallBack
            public Object onCallBack(int i, Context context2, Object obj) {
                if (i != 0) {
                    return null;
    ...
    public static void runApp(Context context, JSONObject jSONObject, Intent intent) {
        try {
            JSONArray jSONArrayOptJSONArray = jSONObject.optJSONObject("report").optJSONArray("intltrackers");
            if (jSONArrayOptJSONArray != null) {
                handleTrackers_wanka(jSONArrayOptJSONArray, jSONObject, "intltrackers");
            }
    ...
    private static void handleTrackers_wanka(JSONArray jSONArray, JSONObject jSONObject, ICallBack iCallBack, String str) {
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            handleTrackers_wanka(ADHandler.formatUrl(jSONObjectOptJSONObject.optString("url"), jSONObject), jSONObjectOptJSONObject.optString("content"), jSONObjectOptJSONObject.optInt("http_method"), 2, iOptInt == 1, iCallBack, str, z);
        }
    }
}
