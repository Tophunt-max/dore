...
class c implements PopupWindow.OnDismissListener, ISysEventListener, EventDispatchManager.ActivityEventDispatchListener {
    ...
    class b implements View.OnKeyListener {
        ...
        public boolean onKey(View view, int i, KeyEvent keyEvent) {
            if (keyEvent.getAction() == 0 && i == 4) {
                if (AbsoluteConst.EVENTS_CLOSE.equalsIgnoreCase(c.this.g)) {
                    c.this.a();
                    c.this.c();
                    return true;
                }
                if ("transmit".equalsIgnoreCase(c.this.g)) {
                    if (!(c.this.f737a instanceof PandoraEntryActivity)) {
                        c.this.f737a.onBackPressed();
    ...
    private void h() {
        Drawable drawable = PdrUtil.isEquals(this.t, "snow") ? PdrUtil.isEquals(this.s, "black") ? this.f737a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_BLACK_SNOW) : this.f737a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_WHITE_SNOW) : PdrUtil.isEquals(this.s, "black") ? this.f737a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_BLACK_CIRCLE) : this.f737a.getResources().getDrawable(PdrR.DRAWBLE_PROGRESSBAR_WHITE_CIRCLE);
        if (this.E > 0) {
    ...
    private void i() {
        ...
        if (this.B) {
            this.o.setOnClickListener(new ViewOnClickListenerC0054c());
        }
    }
    ...
    private void b() {
        LinearLayout linearLayout = (LinearLayout) ((LayoutInflater) this.f737a.getSystemService("layout_inflater")).inflate(NativeUIR.LAYOUT_DIALOG_LAYOUT_LOADING_DCLOUD, (ViewGroup) null, false);
        this.L = linearLayout;
    ...
    private void d() {
        ...
        if (!this.r || (!TextUtils.isEmpty(this.g) && !AbsoluteConst.EVENTS_CLOSE.equalsIgnoreCase(this.g))) {
            if (this.f737a instanceof PandoraEntryActivity) {
