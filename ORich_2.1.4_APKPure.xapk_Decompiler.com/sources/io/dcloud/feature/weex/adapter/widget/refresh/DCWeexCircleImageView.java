...
public class DCWeexCircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(int i, int i2) {
            ...
            RadialGradient radialGradient = new RadialGradient(i3 / 2, i3 / 2, DCWeexCircleImageView.this.mShadowRadius, new int[]{DCWeexCircleImageView.FILL_SHADOW_COLOR, 0}, (float[]) null, Shader.TileMode.CLAMP);
