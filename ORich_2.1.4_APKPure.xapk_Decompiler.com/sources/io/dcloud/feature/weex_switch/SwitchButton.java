...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        int iOptInt = optInt(typedArrayObtainStyledAttributes, R.styleable.SwitchButton_sb_effect_duration, ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION);
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.buttonMaxX = ((f2 - (i6 / 2.0f)) + ((i6 / 2.0f) / 2.0f)) - f3;
        if (isChecked()) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawArc(canvas, f2, f3, f2 + (f4 * 2.0f), ((f4 * 2.0f) + f3) - this.borderWidth, 90.0f, 180.0f, this.paint);
        canvas.drawRect(this.left + this.viewRadius, this.top, this.viewState.buttonX, (this.top + (this.viewRadius * 2.0f)) - this.borderWidth, this.paint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (isPendingDragState()) {
                ...
                viewState2.buttonX = f2 + ((this.buttonMaxX - f2) * this.dragFraction);
