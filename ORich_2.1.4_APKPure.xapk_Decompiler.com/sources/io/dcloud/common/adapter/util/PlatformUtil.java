        ...
        try {
            ...
            if (listQueryIntentActivities != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    jSONObject.put("ver", context.getPackageManager().getPackageInfo(resolveInfo.activityInfo.packageName, 0).versionName);
    ...
    */
    ...
    public static Object invokeMethod(String str, String str2, Object obj, Class[] clsArr, Object[] objArr) {
        ...
        if (str3 != null && !"getJsContent".equals(str2)) {
            Logger.i(RenderTypes.RENDER_TYPE_NATIVE, str3 + Operators.SPACE_STR + str + Operators.SPACE_STR + str2);
        }
        return objInvoke;
    }
