...
public class AssistInputUtil {
    ...
    public static String[] getRecordViewTax() {
        return getCoreRecordViewSaveData(FirebaseAnalytics.Param.TAX);
    }
    ...
    public static void saveCompany(Context context, boolean z, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            editorEdit.commit();
            RecordView.setAssisBundleData(context, "useAssistSettingCompany", AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT);
        }
    }
    ...
    public static void saveEmail(Context context, boolean z, String str, String str2) {
        ...
        editorEdit.commit();
        RecordView.setAssisBundleData(context, "useAssistSettingEmail", AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT);
    }
    ...
    public static void saveId(Context context, boolean z, String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            editorEdit.commit();
            RecordView.setAssisBundleData(context, "useAssistSettingId", AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT);
        }
    }
    ...
    public static void saveName(Context context, boolean z, String str, String str2) {
        ...
        editorEdit.commit();
        RecordView.setAssisBundleData(context, "useAssistSettingName", AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT);
    }
    ...
    public static void savePhone(Context context, boolean z, String str, String str2) {
        ...
        editorEdit.commit();
        RecordView.setAssisBundleData(context, "useAssistSettingPhone", AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT);
    }
    ...
    public static void saveTax(Context context, boolean z, String str) {
        ...
        if (strEncode != null) {
            RecordView.setRcordDatas(context, (String) null, FirebaseAnalytics.Param.TAX, strEncode);
        }
        if (TextUtils.isEmpty(str)) {
            if (TextUtils.isEmpty(str)) {
            ...
            editorEdit.commit();
            RecordView.setAssisBundleData(context, "useAssistSettingTax", AssistPushConsts.PUSHMESSAGE_ACTION_MULTI_BRAND_RECEIVE_GT);
        }
    }
