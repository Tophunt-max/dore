...
public class WebviewActivity extends DCloudBaseActivity implements View.OnClickListener {
    ...
    class b extends WebViewClient {
        ...
        class a implements View.OnClickListener {
            ...
            public void onClick(View view) {
                WebviewActivity.this.startActivity(this.f495a);
            }
        }
        ...
        class DialogInterfaceOnClickListenerC0021b implements DialogInterface.OnClickListener {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ AlertDialog f496a;
            final /* synthetic */ SslError b;
            final /* synthetic */ SslErrorHandler c;

            DialogInterfaceOnClickListenerC0021b(b bVar, AlertDialog alertDialog, SslError sslError, SslErrorHandler sslErrorHandler) {
                this.f496a = alertDialog;
                this.b = sslError;
        ...
        public void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
            if (sslErrorHandler != null) {
                ...
                DialogInterfaceOnClickListenerC0021b dialogInterfaceOnClickListenerC0021b = new DialogInterfaceOnClickListenerC0021b(this, alertDialogCreate, sslError, sslErrorHandler);
                alertDialogCreate.setButton(-2, WebviewActivity.this.getString(R.string.cancel), dialogInterfaceOnClickListenerC0021b);
                alertDialogCreate.setButton(-1, WebviewActivity.this.getString(R.string.ok), dialogInterfaceOnClickListenerC0021b);
    ...
    class c implements DownloadListener {
        ...
        class a implements View.OnClickListener {
            ...
            class C0022a implements ILoadCallBack {
                C0022a() {
                }
            ...
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                DownloadUtil.getInstance(WebviewActivity.this.that).startRequest(WebviewActivity.this.that, this.f498a, this.b, this.c, this.d, new C0022a());
            }
        }
    ...
    static class e extends View {
        ...
        e(Context context) {
            ...
            this.f = 0;
            this.g = 255;
            this.f501a = context.getResources().getDisplayMetrics().widthPixels;
        ...
        protected void onMeasure(int i, int i2) {
            ...
            setMeasuredDimension(this.f501a, this.c + ((int) this.b));
        }

        void a(int i) {
            this.h = i;
            int i2 = (this.f501a * i) / 100;
            if (this.e >= this.f) {
    ...
    private void h() {
        ...
        this.f492a = (TextView) findViewById(PdrR.WEBVIEW_ACTIVITY_LAYOUT_BACK);
        ...
        this.f492a.setText("\ue601");
        this.f492a.setTypeface(typefaceCreateFromAsset);
        float f = iPxFromDp;
        this.f492a.getPaint().setTextSize(f);
        this.b.setText("\ue650");
    ...
    private void a(WebView webView) {
        if (webView != null) {
            ...
            PlatformUtil.invokeMethod(settings, io.dcloud.h.a.a("f2l4TWBgY3tKZWBpTW9vaX9/KjZhM2Q4OGZhLTRiYTAtNDc5Zi05NDIyLWU1YWFiZTE1ODk3Yjc2", true, 12), new Class[]{Boolean.TYPE}, Boolean.TRUE);
