...
public class b implements IConfusionMgr {
    ...
    private static IConfusionMgr j;
    private DCI b;
    ...
    private b() {
        Object objInvokeMethod = PlatformUtil.invokeMethod(decodeString(b(), true, this.f772a), "getInstance", null);
    ...
    public Map<String, String> getData(String str) {
        Object objInvokeMethod = PlatformUtil.invokeMethod(decodeString(a(), true, this.f772a), "getData", null, new Class[]{String.class}, new Object[]{str});
    ...
    public InputStream getEncryptionInputStream(String str, IApp iApp) {
        ...
        InputStream fileInputStream = (Boolean.parseBoolean(iApp.obtainConfigProperty(IApp.ConfigProperty.CONFIG_USE_V3_ENCRYPTION)) || (objInvokeMethod = PlatformUtil.invokeMethod(decodeString(a(), true, this.f772a), decodeString("b218TWZrenF4fGFnZkFmeH18W3x6bWll"), null, new Class[]{String.class, IApp.class}, new Object[]{str, iApp})) == null || !(objInvokeMethod instanceof InputStream)) ? null : (InputStream) objInvokeMethod;
    ...
    public String handleEncryption(Context context, byte[] bArr) {
        Object objInvokeMethod = PlatformUtil.invokeMethod(decodeString(a(), true, this.f772a), decodeString("YGlmbGRtTWZrenF4fGFnZg=="), null, new Class[]{Context.class, byte[].class}, new Object[]{context, bArr});
    ...
    public void recordEncryptionResources(String str, JSONObject jSONObject) {
        PlatformUtil.invokeMethod(decodeString(a(), true, this.f772a), decodeString("em1rZ3psTWZrenF4fGFnZlpte2d9emttew=="), null, new Class[]{String.class, JSONObject.class}, new Object[]{str, jSONObject});
    }
    ...
    public void removeData(String str) {
        PlatformUtil.invokeMethod(decodeString(a(), true, this.f772a), "removeData", null, new Class[]{String.class}, new Object[]{str});
    }
