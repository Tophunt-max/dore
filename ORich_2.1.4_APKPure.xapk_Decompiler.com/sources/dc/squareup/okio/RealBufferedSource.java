...
final class RealBufferedSource implements BufferedSource {
    ...
    public long readDecimalLong() throws IOException {
        ...
        if (i == 0) {
            throw new NumberFormatException(StringUtil.format("Expected leading [0-9] or '-' character but was %#x", Byte.valueOf(b)));
        }
    ...
    public long readHexadecimalUnsignedLong() throws IOException {
        ...
        if (i == 0) {
            throw new NumberFormatException(StringUtil.format("Expected leading [0-9a-fA-F] character but was %#x", Byte.valueOf(b)));
        }
    ...
    public long indexOf(byte b, long j, long j2) throws IOException {
        ...
        if (j < 0 || j2 < j) {
            throw new IllegalArgumentException(StringUtil.format("fromIndex=%s toIndex=%s", Long.valueOf(j), Long.valueOf(j2)));
        }
        while (j < j2) {
