...
export const catalog = {
  ...
  'game.balance': { en: 'Points balance', hi: 'पॉइंट बैलेंस', zh: '积分余额' },
  'game.recharge': { en: 'Recharge', hi: 'रिचार्ज', zh: '充值' },
  'game.period': { en: 'Round', hi: 'राउंड', zh: '期号' },
  'game.green': { en: 'Green', hi: 'हरा', zh: '绿' },
  'game.violet': { en: 'Violet', hi: 'बैंगनी', zh: '紫' },
  'game.red': { en: 'Red', hi: 'लाल', zh: '红' },
  'game.pick': { en: 'Pick a colour to play', hi: 'खेलने के लिए रंग चुनें', zh: '选择颜色进行游戏' },
  'game.rulesNav': { en: 'Rules', hi: 'नियम', zh: '规则' },
  'game.nonMonetary': {
    en: 'Non-monetary play only — no wager, no cash payout.',
    hi: 'केवल गैर-मौद्रिक खेल — कोई दाँव नहीं, कोई नकद भुगतान नहीं।',
    zh: '仅限非金钱游戏 — 无投注、无现金支付。',
  },
  ...
  'team.people': { en: 'people', hi: 'लोग', zh: '人' },
  'team.amount': { en: 'Total reward', hi: 'कुल इनाम', zh: '累计奖励' },
  'team.qualified': { en: 'Qualified', hi: 'योग्य', zh: '已达标' },
  'team.direct': { en: 'Direct', hi: 'प्रत्यक्ष', zh: '直推' },
  'team.step1': { en: 'Share link', hi: 'लिंक शेयर करें', zh: '分享链接' },
  'team.step2': { en: 'Friend registers', hi: 'मित्र पंजीकरण', zh: '好友注册' },
  'team.step3': { en: 'Earn rewards', hi: 'इनाम पाएं', zh: '获得奖励' },
  'team.inviteNow': { en: 'Invite now', hi: 'अभी आमंत्रित करें', zh: '立即邀请' },
  'team.inviteLink': { en: 'My invite link', hi: 'मेरा लिंक', zh: '我的邀请链接' },
  'team.copy': { en: 'Copy', hi: 'कॉपी', zh: '复制' },
  'team.copied': { en: 'Copied', hi: 'कॉपी हो गया', zh: '已复制' },
  'team.membersTab': { en: 'Team members', hi: 'टीम सदस्य', zh: '团队成员' },
  'invite.invited': { en: 'Invited', hi: 'आमंत्रित', zh: '已邀请' },
  'invite.reward': { en: 'Reward', hi: 'इनाम', zh: '奖励' },
  'invite.myLink': { en: 'My invite link', hi: 'मेरा लिंक', zh: '我的邀请链接' },
  'invite.copy': { en: 'Copy', hi: 'कॉपी', zh: '复制' },
  'invite.now': { en: 'INVITE', hi: 'आमंत्रित करें', zh: '立即邀请' },
  'invite.rules': { en: 'Rules', hi: 'नियम', zh: '规则' },
  'invite.friends': { en: 'Friends', hi: 'मित्र', zh: '好友' },
  'invite.rebate': { en: 'Rebate records', hi: 'रिबेट रिकॉर्ड', zh: '返利记录' },
  'invite.people': { en: 'people', hi: 'लोग', zh: '人' },
